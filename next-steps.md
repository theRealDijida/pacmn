...
<img src="{% if jekyll.environment == 'production' %}{{ site.doks.baseurl }}{% endif %}/images/mngov3.png" style="display: block;margin-left: auto;margin-right: auto;width: 100%;"/>

<br/>

If you want to vote **Yes** for the proposal, leave the string as is. If you want to vote **No**, then simply change the 'yes' to a 'no'. Hit enter and you should see your vote registered on the network as shown below:

<br/>

<img src="{% if jekyll.environment == 'production' %}{{ site.doks.baseurl }}{% endif %}/images/mngov4.png" style="display: block;margin-left: auto;margin-right: auto;width: 100%;"/>
